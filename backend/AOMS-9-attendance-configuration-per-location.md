...
> **DEPRECATED (v4.0):** This ticket documents the original Spring Boot implementation. The canonical FastAPI implementation is in [backend/attendance-service/AOMS-9-attendance-configuration-per-location.md](attendance-service/AOMS-9-attendance-configuration-per-location.md).
